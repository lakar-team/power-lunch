    ...
    if (success) {
        return (
            <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md text-center">
                ...
                <Link href={`/auth/login?redirect=${redirectTo}`} className="pl-btn pl-btn-secondary">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="mt-8 text-center">
                <p className="text-gray-500">
                    ...
                    <Link href={`/auth/login?redirect=${redirectTo}`} className="text-green-600 font-bold hover:underline">
