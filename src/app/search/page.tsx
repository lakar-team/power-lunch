...
// Sample listings data - in production this would come from Supabase
const sampleListings = [
    { id: '1', lat: 38.2610, lng: 140.8810, price: 800, title: 'Python Code Review', category: 'tech', host: 'Ken M.' },
    { id: '2', lat: 38.2620, lng: 140.8850, price: 2000, title: 'Design Feedback', category: 'design', host: 'Lisa T.' },
    { id: '3', lat: 38.2590, lng: 140.8830, price: 1500, title: 'English Conversation', category: 'english', host: 'Adam R.' },
    { id: '4', lat: 38.2605, lng: 140.8870, price: 1000, title: 'Career Advice', category: 'career', host: 'Yuki S.' },
]
...
export default function SearchPage() {
    ...
    useEffect(() => {
        ...
        // Add listing markers
        addMarkers(L, map, sampleListings)

    }, [mapLoaded])

    // Add markers function
    const addMarkers = (L: any, map: any, listings: typeof sampleListings) => {
        // Clear existing markers
        markersRef.current.forEach(m => map.removeLayer(m))
        markersRef.current = []

        listings.forEach(listing => {
            const isHighlighted = listing.category === 'english'
            ...
            marker._category = listing.category
            marker._price = listing.price
    ...
    const handleFilterClick = (filterKey: string) => {
        ...
        markersRef.current.forEach((marker, index) => {
            ...
            if (filterKey === 'all') {
                ...
                shouldShow = listing.price < 1000
            } else {
                shouldShow = listing.category === filterKey
            }
